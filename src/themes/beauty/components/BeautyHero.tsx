    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          className="w-full h-full bg-[url('/beauty/salon_hero_bg.jpg')] bg-cover bg-center"
        />
      ...
      <div className="relative z-10 text-center px-6 mt-32">
        ...
        >
          ...
          <p className={`${jost.className} tracking-[0.05em] text-lg md:text-xl text-[#FDFCF9]/95 max-w-2xl mx-auto mb-10 drop-shadow-md leading-[1.8] font-light`}>
            Saç tasarımı, protez tırnak, profesyonel manikür & pedikür ve ipek kirpik uygulamalarıyla lüks bir bakım deneyimine davetlisiniz.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-5 items-center justify-center mt-6">
            <Link href="/hizmetler" className="inline-flex items-center justify-center border border-[#FDFCF9]/60 text-[#FDFCF9] font-sans font-medium text-[10px] tracking-widest uppercase px-8 py-3 rounded-full hover:bg-[#FDFCF9] hover:text-[#3E2B2B] transition-all duration-500 backdrop-blur-sm">
              Tüm Hizmetler
            </Link>
