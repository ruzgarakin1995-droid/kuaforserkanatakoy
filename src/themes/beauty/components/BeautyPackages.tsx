  ...
  const packages = [
    {
      ...
      price: "1.850",
      originalPrice: "2.100",
      description: "Günlük güzelliğinizi ön plana çıkaran temel bakım ritüeli.",
      features: [
        "Detaylı Manikür & Pedikür",
    ...
    },
    {
      ...
      price: "4.900",
      originalPrice: "5.500",
      description: "Baştan aşağı yenilenmek isteyenler için VIP dönüşüm deneyimi.",
      isPopular: true,
      features: [
        "Profesyonel Saç Renklendirme",
        "Protez Tırnak Uygulaması",
        "Olaplex Koruyucu Bakım",
        "İpek Kirpik (Klasik Set)"
      ]
    },
    {
      ...
      price: "3.200",
      originalPrice: "3.600",
      description: "Etkileyici bakışlar ve kusursuz detaylar bir arada.",
      features: [
        "İpek Kirpik (Volume Set)",
        "Kirpik Lifting",
        "Kalıcı Oje (El & Ayak)",
        "SPA Pedikür & Peeling"
      ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          {packages.map((pkg, idx) => (
            <motion.div
              ...
              className={`
                relative p-8 md:p-12 border transition-all duration-500 flex flex-col h-full
                ${pkg.isPopular 
            ...
            >
              ...
              <div className={`mt-6 mb-8 pb-8 border-b flex-grow-0 ${pkg.isPopular ? 'border-[#FAF5F0]/10' : 'border-[#3E2B2B]/10'}`}>
              ...
              <button 
                 ...
                 className={`
                  w-full py-4 text-[10px] font-sans font-medium tracking-[0.2em] uppercase transition-colors rounded mt-auto
                  ${pkg.isPopular 
