    ...
    <section className="relative h-[80vh] w-full flex items-center justify-start overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          className="w-full h-full bg-[url('/beauty/beauty_makeup_1786272894523.jpg')] bg-cover bg-center"
        />
      ...
      <div className="relative z-10 px-6 lg:px-24 w-full max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
             ...
             <span className="text-[10px] font-sans font-medium tracking-[0.3em] uppercase text-[#D4A373]">Bütünsel Güzellik</span>
          </div>
          ...
          <p className="font-sans text-sm md:text-base text-[#3E2B2B]/80 leading-relaxed mb-10">
            Uzman kadromuz tarafından uygulanan yenilikçi saç tasarımları, kusursuz protez tırnak ve detaylı manikür & pedikür bakımlarıyla kendinizi şımartın. İpek kirpik uygulamalarımızla ise bakışlarınıza anlam katan kalıcı ve etkileyici çözümler sunuyoruz.
          </p>
