      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
          ...
          <div className="md:col-span-4">
            <span className="text-3xl font-serif text-[#FAF5F0] block mb-1">Kuaför Serkan Ataköy</span>
            <span className="text-[9px] font-sans tracking-[0.3em] uppercase text-[#D4A373] block mb-8">Saç Tasarım & Güzellik</span>
            <p className="font-sans text-sm text-[#FDFCF9]/60 leading-relaxed pr-8">
              Kuaför Serkan Ataköy, kendinize ayırdığınız en değerli zaman dilimini, en saf zarafet ve profesyonellikle taçlandırır.
            </p>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 font-sans text-sm text-[#FDFCF9]/80">
              <li><a href="/hizmetler" className="hover:text-[#D4A373] transition-colors">Saç Tasarımı & Renklendirme</a></li>
              <li><a href="/hizmetler" className="hover:text-[#D4A373] transition-colors">Protez Tırnak & Kalıcı Oje</a></li>
              <li><a href="/hizmetler" className="hover:text-[#D4A373] transition-colors">Manikür & Pedikür</a></li>
              <li><a href="/hizmetler" className="hover:text-[#D4A373] transition-colors">İpek Kirpik & Kaş</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 font-sans text-sm text-[#FDFCF9]/80">
              <li className="leading-relaxed">Kuaför Serkan Ataköy, Merkez,<br/>Ataköy 7-8. Kısım Mah. Defne Sok. Martı Sitesi 3. Blok No:17<br/>Bakırköy, Istanbul, Turkey</li>
              <li><a href="tel:+905421020627" className="hover:text-[#D4A373] transition-colors underline underline-offset-4 decoration-[#FDFCF9]/30 hover:decoration-[#D4A373]">+90 542 102 06 27</a></li>
              <li><a href="mailto:info@kuaforserkanatakoy.com" className="hover:text-[#D4A373] transition-colors">info@kuaforserkanatakoy.com</a></li>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="border-t border-[#FDFCF9]/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-sans text-[10px] text-[#FDFCF9]/40 tracking-wider">
            &copy; 2026 Kuaför Serkan Ataköy. Tüm Hakları Saklıdır.
          </p>
