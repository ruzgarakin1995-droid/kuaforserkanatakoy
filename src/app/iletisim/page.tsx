    ...
    <main className="bg-[#FAF5F0] min-h-screen text-[#3E2B2B] selection:bg-[#D4A373] selection:text-[#FAF5F0]">
      ...
      <section className="pt-48 pb-24 px-6 lg:px-8 bg-[#3E2B2B] relative overflow-hidden">
        <div className="absolute inset-0 z-0">
           <img src="/beauty/beauty_interior_detail_1786272904875.jpg" alt="Kuaför Serkan Ataköy Interior" className="w-full h-full object-cover opacity-20" />
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="font-sans text-[#3E2B2B]/80 leading-relaxed">
                    Kuaför Serkan Ataköy, Merkez<br/>
                    Ataköy 7-8. Kısım Mah. Defne Sok. Martı Sitesi 3. Blok No:17<br/>Bakırköy, Istanbul, Turkey
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="font-sans text-[#3E2B2B]/80 leading-relaxed">
                    <a href="tel:+905421020627" className="hover:text-[#D4A373] transition-colors block mb-1">+90 542 102 06 27</a>
                    <a href="mailto:info@kuaforserkanatakoy.com" className="hover:text-[#D4A373] transition-colors block">info@kuaforserkanatakoy.com</a>
                  </p>
                </div>
              </div>
